function Work(){
	var chushi=(function(){
		...
		move(".titl").set("opacity","1").duration('1.2s').end(function(){
			move(".cp").set("top","218px").duration('.6s').end();
			move(".cpdap").set("top","228px").duration('.6s').end(function(){
				move(".ht").set("top","410px").duration('1s').end();
				move(".htdap").set("top","410px").duration('1s').end();
				move(".cs").set("top","450px").duration('1.8s').end();
				move(".csdap").set("top","450px").duration('1.8s').end(function(){
			...
			move(".ui").set("top","218px").duration('1.4s').end();
